...
export async function getPumpFunPriceOnce(recordOrMint) {
  ...
  // decimals: read from input if provided, else fetch on-chain
  const inputDecimals =
    typeof recordOrMint === "object" && recordOrMint !== null ? recordOrMint.decimals : undefined;

  let decimals = Number(inputDecimals);
