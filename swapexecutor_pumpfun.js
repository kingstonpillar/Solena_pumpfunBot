import { PublicKey, Transaction, sendAndConfirmTransaction, Keypair, Connection, TransactionInstruction } from '@solana/web3.js';
...
// Program ID for Pumpfun and Token Program
const PUMPFUN_PROGRAM_ID = new PublicKey("6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P");  // Correct Pumpfun Program ID
...
console.log(amountSolBytes); // Log the byte array
  ...
  programId: PUMPFUN_PROGRAM_ID,  // Using the correct Pumpfun program ID
