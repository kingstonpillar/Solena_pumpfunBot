...
import { TOKEN_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID, getAssociatedTokenAddress, createAssociatedTokenAccountInstruction, TOKEN_2022_PROGRAM_ID } from '@solana/spl-token';  // Correct imports

// Ensure you initialize the TOKEN_2022_PROGRAM_ID properly, if you're using it for Token 2022

const tokenProgramId = TOKEN_2022_PROGRAM_ID;  // Only if you're working with Token 2022
...
// Print all methods available in PumpAmmSdk
console.log("Available methods in PumpAmmSdk:", Object.getOwnPropertyNames(PumpAmmSdk.prototype))
