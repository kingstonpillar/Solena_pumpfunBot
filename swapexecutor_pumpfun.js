...
export async function executePumpfunBuyFromBonding({
  ...
  // Step 4: Get the amount of SOL to spend from the environment variable (SOL_TO_SPEND in lamports)
  const amountSol = process.env.SOL_TO_SPEND ? BigInt(process.env.SOL_TO_SPEND) : 1_000_000n; // Default to 1 SOL (1,000,000 lamports)
