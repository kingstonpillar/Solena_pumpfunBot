...
const top10Pct = await Top10PCT(mintStr); // MUST be a real number now
...
console.log(`Top 10 holders own: ${top10Pct.toFixed(2)}% of the total supply.`);
console.log(`Score after top10 adjustment: ${score}`);
