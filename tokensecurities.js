...
export async function checkTokenSecurity(mintOrRecord) {
  ...
  let t10 = null;
  try {
    t10 = await Top10PCT(mintPub);  // Make sure Top10PCT is called correctly
  } catch (err) {
    console.error('Error fetching top 10 data:', err);
    t10 = { pct: null, reason: "rpc_fail" }; // Make sure to handle this
  }

  // Log the top 10 percentage and reason for debugging
