...
export class SolanaDeepBuyBot {
  ...
  console.log("Token Mint:", this.tokenMint);
  console.log("Current State:", this.currentState);
  console.log("Has Bought:", this.hasBought);
  console.log("Is Blocked:", this.isBlocked);
  console.log("Market Cap:", this.currentMarketCap);
  console.log("Pair Address:", this.pairAddress);
  console.log("Retracement %:", this.retracementPct);
  console.log("Last RSI:", this.lastRSI ?? "N/A");
  console.log("Deep Buy Summary:", this.deepBuySummary ?? "N/A");
  console.log("Reason:", !tickResult.ok
    ? "ERROR"
    : this.hasBought
    ? "BOUGHT"
    : this.isBlocked
  ...
  if (tickResult.error) console.log("Tick Error:", tickResult.error);
  console.log("======================\n");
