...
export async function executeAutoSellPumpfun({ mint, tokenAccount, amount }) {
  ...
  const bondingCurvePublicKey = new PublicKey("BONDING_CURVE_PUBLIC_KEY"); // Replace with your bonding curve public key
  const ammPoolPublicKey = new PublicKey("AMM_POOL_PUBLIC_KEY"); // Replace with your AMM pool public key
