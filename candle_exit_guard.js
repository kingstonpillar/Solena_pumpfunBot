...
if (!mint) {
  console.log("[candle_guard][SKIP] invalid mint:", rawMint);
  continue;
}

if (String(rawMint).toLowerCase().endsWith("pump")) {
  console.log("[candle_guard][MINT] stripped pump suffix:", rawMint, "->", mint);
}
